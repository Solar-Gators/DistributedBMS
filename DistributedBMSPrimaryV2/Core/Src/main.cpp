...
osThreadId_t fleetTaskHandle;
const osThreadAttr_t fleetTask_attributes = {
  .name = "fleetTask",
  .stack_size = 1024U * 2,
  .priority = (osPriority_t) osPriorityNormal,
};
osThreadId_t vehicleTxTaskHandle;
const osThreadAttr_t vehicleTxTask_attributes = {
  .name = "vehicleTxTask",
  .stack_size = 1024U * 3,
  .priority = (osPriority_t) osPriorityAboveNormal,
};
osThreadId_t auxTaskHandle;
const osThreadAttr_t auxTask_attributes = {
  .name = "auxTask",
  .stack_size = 1024U * 2,
...
int main(void)
{
  ...
  MX_TIM8_Init();
  /* USER CODE BEGIN 2 */
  /* CanBus: global filter + HAL_FDCAN_Start + RX IRQ — required or FDCAN never joins the bus */
  setup();
  /* USER CODE END 2 */
  ...
  fleetTaskHandle = osThreadNew(StartFleetTask, NULL, &fleetTask_attributes);
...
static void MX_SPI1_Init(void)
{
  ...
  /* ADS131M02: SPI mode 1 (CPOL=0, CPHA=1) -> sample on second edge (STM32: 2EDGE). */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, ERROR_LED_Pin|FAULT_LED_Pin|NCS_A_Pin|NCS_L_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(IN0_GPIO_Port, IN0_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, IN1_Pin|IN2_Pin|IN3_Pin|STB_FDCAN3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : NREADY_Pin */
  GPIO_InitStruct.Pin = NREADY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(NREADY_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : IN1_Pin IN2_Pin IN3_Pin STB_FDCAN3_Pin */
  GPIO_InitStruct.Pin = IN1_Pin|IN2_Pin|IN3_Pin|STB_FDCAN3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
